          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Admin  insert</h3>
              </div>
              <!-- /.card-header -->
              ...
              <form method="post" action="connect/route.php" >
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="surname" class="form-control" id="" placeholder="Enter surname">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="comfirm_password" class="form-control" id="" placeholder="Enter comfirm password">
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="admin_insert">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
